...
6. **Magenta discipline.** Magenta `#E70641` only on "Create cycle", "Save changes", and the cycle pill. Status uses its own palette; the active-cycle warning is amber, never magenta.
